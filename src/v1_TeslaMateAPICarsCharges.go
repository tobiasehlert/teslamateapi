...
func TeslaMateAPICarsChargesV1(c *gin.Context) {
	...
	ParsedStartDate, err = parseAndValidateDate(StartDate, "TeslaMateAPICarsChargesV1", CarsChargesError2)
	if err != nil {
		TeslaMateAPIHandleErrorResponse(c, "TeslaMateAPICarsChargesV1", CarsChargesError2, fmt.Sprintf("Invalid startDate: %s", err.Error()))
		return
	}

	ParsedEndDate, err = parseAndValidateDate(EndDate, "TeslaMateAPICarsChargesV1", CarsChargesError2)
	if err != nil {
